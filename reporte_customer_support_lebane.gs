function doGet() {
  return HtmlService.createHtmlOutput(getHtml())
    .setTitle('Encuesta de clima — Customer Support | Lebane');
}
...
<div class="page">
  <div class="area-card">
    <div class="card-header">
      <span class="area-name">Customer Support</span>
      <div class="metrics-row">
        <div class="metric-pill"><span class="m-label">Participación</span><span class="m-value" style="color:var(--yellow)">67%</span><span class="m-sub">2 / 3</span></div>
        <div class="metric-pill"><span class="m-label">Favorabilidad</span><span class="m-value" style="color:var(--green)">78.1%</span><span class="m-sub">puntaje</span></div>
        <div class="metric-pill"><span class="m-label">eNPS</span><span class="m-value" style="color:var(--green);">+50</span><span class="m-sub">Net Promoter Score</span></div>
        <div class="metric-pill"><span class="m-label">Respuestas</span><span class="m-value" style="color:var(--blue-dark)">2</span><span class="m-sub">personas</span></div>
      </div>
    </div>
    <div class="card-body">
      <div class="enps-section">
        ...
        <div class="dist-bar">
          ...
          <div class="seg-yel" style="width:50%"></div>
          <div class="seg-green" style="width:50%"></div>
        </div>
        <div class="dist-legend">
          <span><span class="dot" style="background:var(--red)"></span>Detractores 0%</span>
          <span><span class="dot" style="background:var(--yellow)"></span>Neutros 50%</span>
          <span><span class="dot" style="background:var(--green)"></span>Promotores 50%</span>
        </div>
      </div>
      ...
      <table class="q-table">
        ...
        <tr><td class="q-label">Siento que en Lebane tengo la oportunidad de aprender y crecer profesionalmente</td><td class="q-bar-cell"><div class="q-bar-bg"><div class="q-bar-fill high" style="width:70.0%"></div></div></td><td class="q-pct-cell high">70.0</td></tr>
      ...
      <table class="q-table">
        <tr><td class="q-label">Tengo claro qué es lo que tengo que lograr o conseguir</td><td class="q-bar-cell"><div class="q-bar-bg"><div class="q-bar-fill high" style="width:70.0%"></div></div></td><td class="q-pct-cell high">70.0</td></tr>
      ...
      <table class="q-table">
        ...
        <tr><td class="q-label">En Lebane puedo ser yo mismo/a</td><td class="q-bar-cell"><div class="q-bar-bg"><div class="q-bar-fill high" style="width:70.0%"></div></div></td><td class="q-pct-cell high">70.0</td></tr>
      ...
      <table class="q-table">
        <tr><td class="q-label">Hay claridad en la comunicación</td><td class="q-bar-cell"><div class="q-bar-bg"><div class="q-bar-fill high" style="width:70.0%"></div></div></td><td class="q-pct-cell high">70.0</td></tr>
      </table>
      ...
      <table class="q-table">
        ...
        <tr><td class="q-label">Habitualmente debo hacer mayores esfuerzos del ordinario para llevar a cabo mi trabaj…</td><td class="q-bar-cell"><div class="q-bar-bg"><div class="q-bar-fill mid" style="width:60.0%"></div></div></td><td class="q-pct-cell mid">60.0</td></tr>
      ...
      <table class="q-table">
        ...
        <tr><td class="q-label">Cuando me equivoco o no lo hago del todo bien, mi líder me da feedback para mejorar</td><td class="q-bar-cell"><div class="q-bar-bg"><div class="q-bar-fill high" style="width:70.0%"></div></div></td><td class="q-pct-cell high">70.0</td></tr>
      ...
      <div class="comment-bubble">El equipo de trabajo.
El producto</div>
      <div class="comment-bubble">La forma de trabajar, el grupo de trabajo y la oficina actual</div>
      <div class="q-section-label">⚠️ LO QUE MENOS GUSTA</div>
      <div class="comment-bubble">La cantidad de dias presenciales. 
Con uno seria suficiente.</div>
      <div class="comment-bubble">Lo que menos me gusta es la desorganización en ciertas cuestiones, aunque entiendo que se trata por el crecimiento de la empresa.</div>
      <div class="q-section-label">👤 COMENTARIOS SOBRE EL LÍDER</div>
      <div class="comment-bubble">Estoy muy contento y cómodo con mi líder.</div>
